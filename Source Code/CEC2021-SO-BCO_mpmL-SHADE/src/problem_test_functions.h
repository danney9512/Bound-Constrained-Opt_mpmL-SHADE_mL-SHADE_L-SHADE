...
namespace CEC2021
{
	...
	double cf02(const Individual::GeneVec& gene_vec, const CProblem& prob);		/* Modified Composition Function cf02 for shift case*/
	double cf04(const Individual::GeneVec& gene_vec, const CProblem& prob);		/* Modified Composition Function cf04 for shift case*/
	double cf05(const Individual::GeneVec& gene_vec, const CProblem& prob);		/* Modified Composition Function cf05 for shift case*/
}

...
public:
	...
	const std::string& func_setting_name() const { return func_setting_; }
	...
	void set_func_setting_name(const std::string & setting) { func_setting_ = setting; }
	...
	void load_shift_data(const size_t times);
	void load_rotation_matrix_data(const size_t times);
	void load_shuffle_data(const size_t times);
